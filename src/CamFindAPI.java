...
public class CamFindAPI {
    ...
    public String getImageResponse(String token) throws UnirestException {
        ...
        HttpResponse<JsonNode> description = Unirest
                .get("https://camfind.p.mashape.com/image_responses/5k6WX0Yk7rk8zzD3McuT_Q")
                .header("X-Mashape-Key", "GXAEZZIp78mshXbId2kurGfdvAlvp1XlRjsjsn70l25nGbvS0d")
                .header("Accept", "application/json").asJson();

        String status = (String) description.getBody().getObject().get("status");

        System.out.println(description.getBody() + " isssss: " + status);
    ...
    public String temp(String url) throws UnirestException {
        ...
        System.out.println("yoloooooooooo " + token);
